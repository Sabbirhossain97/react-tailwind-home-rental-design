      ...
      <header className="text-gray-600 body-font  ">
        <div className="container mx-auto w-3/4 flex flex-wrap p-5 flex-col md:flex-row items-center">
          ...
          <nav className="mt-6 inline-flex md:ml-auto flex-col md:flex-row text-white font-dm-sans font-normal not-italic  items-center text-base">
            <a className="py-[20px] px-[20px] transition cursor-pointer md:mr-[56px] text-[20px] md:text-[18px] hover:text-[#F4511E]">
              Home
            </a>
            <a className="py-[20px] px-[20px] transition cursor-pointer md:mr-[56px] text-[20px] md:text-[18px] mt-2 md:mt-0 hover:text-[#F4511E]">
              Landlord
            </a>
            <a className="py-[20px] px-[20px] transition cursor-pointer md:mr-[56px] text-[20px] md:text-[18px] mt-2 md:mt-0  hover:text-[#F4511E]">
              Tenants
            </a>
            <a className="py-[20px] px-[20px] transition cursor-pointer md:mr-5 text-[20px] md:text-[18px] mt-2 md:mt-0  hover:text-[#F4511E]">
              Contact Us
            </a>
          </nav>
        </div>

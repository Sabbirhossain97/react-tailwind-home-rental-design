        ...
        <div className="mt-9  flex flex-wrap xl:flex-nowrap">
          ...
          <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0 ">
            {[
              ...
              <div
                className={` flex flex-col ${item.position}`}
                key={key}
              >
                <div className="">
                  <img
                ...
                <p className="whitespace-wrap inline-flex mt-[21px] font-inter text-[26px] not-italic font-semibold leading-[35px] capitalize">
                  {item.text}
                </p>
              </div>
            ))}

        ...
        <section className="text-gray-600 body-font ">
          <div className="container mx-auto flex px-5 w-3/4 py-24 md:flex-row flex-col md:flex-wrap lg:flex-nowrap justify-center items-center">
            ...
            <div className=" lg:max-w-lg md:w-3/4 w-full flex flex-col justify-center">
              ...
              <div className="border bg-white w-11/12 md:w-5/6 lg:w-4/5 py-[15px] lg:max-w-lg rounded-lg flex flex-col sm:flex-row mx-auto justify-center">
                ...
                <div className=" border flex px-2 py-2 md:px-0 md:py-0 justify-end md:justify-center items-center w-full md:w-[70px] rounded-r-md bg-slate-700 md:bg-[#23A6F0] ">
                  <button>

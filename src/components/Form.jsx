    ...
    <div>
      <div className="mt-[110px] ">
        <div className="text-center">
          <p className="text-black font-inter text-[24px] font-medium leading-8 capitalize">
            Your property with us and be Confident that Your Room will be Filled
            Out!
          </p>
        </div>
        <div className="w-3/4 shadow-form-wrapper rounded-[10px] bg-[#FFF] mx-auto mt-[37px]">
          <div className=" py-4">
            <p className="flex justify-center mt-10 text-[#F4511E] font-poppins text-center text-[28px] not-italic font-bold leading-8 tracking-[0.1px]">
              Add A New Property
            </p>
          </div>
          <form>
            <div className=" grid grid-cols-3 mt-[65px] grid-rows-5  w-4/5 mx-auto gap-x-[25px] gap-y-[25px]">
              ...
              <div class="col-span-full">
                ...
                <div className="flex justify-center mt-[55px] mb-[55px]">
                  <button className="rounded-[9px] bg-[#F4511E] px-[158px] py-[21.79px] text-white font-inter text-[21px] font-medium not-italic leading-[25px] tracking-[0.182px]">
                    Add New Property
                  </button>
                </div>
              </div>

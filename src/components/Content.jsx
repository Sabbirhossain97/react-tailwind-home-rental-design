...
export default function Content() {
  return (
    <div>
      <div className="w-3/4 4xl:w-3/5 mx-auto mt-[110px] ">
        <div className="flex flex-wrap">
          {/* left section */}
          <div className="flex w-11/12 mx-auto md:w-1/2 4xl:w-1/3 flex-wrap ">
          ...
          {/* right section */}
          <div className=" mx-auto w-11/12 mt-10 md:mt-0 md:w-1/2 4xl:w-2/5 flex flex-col justify-center items-center  ">
